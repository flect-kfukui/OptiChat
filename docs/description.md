# OptiChat Streamlit Application Sequence Diagram
...
The OptiChat application is a Streamlit-based interactive dialogue system that allows users to interact with Pyomo optimization models using natural language. The application follows a multi-agent architecture with specialized agents for different tasks.
